...
public class MetricsService {
    ...
    public Mono<DashboardStatsDto> getDashboardStats(
        ...
        return db.sql(sql)
                ...
                .defaultIfEmpty(DashboardStatsDto.builder()
                        .totalVerifications(0L).successCount(0L).failureCount(0L).pendingCount(0L).totalUsers(0L)
    ...
    public Flux<DetailedVerificationDto> getSuccessfulVerifications(Long platformId, LocalDateTime from,
            LocalDateTime to) {
