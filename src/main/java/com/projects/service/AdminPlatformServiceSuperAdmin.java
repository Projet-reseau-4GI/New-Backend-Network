...
import com.projects.repository.VerificationLogRepository;
...
public class AdminPlatformServiceSuperAdmin {
         ...
         */
        private AdminVerificationResultDtoSuperAdmin mapToResultDto(com.projects.model.VerificationLog log) {
