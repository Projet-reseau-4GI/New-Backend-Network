...
public class JwtService {
    ...
    public String generateToken(String email, Long platformId, String name) {
        return generateToken(email, platformId, name, null);
    }

    /** Generate a JWT for a platform or admin with an optional role. */
    public String generateToken(String email, Long platformId, String name, String role) {
        Date now    = new Date();
