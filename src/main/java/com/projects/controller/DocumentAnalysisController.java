...
import com.projects.service.EnhancedDocumentService;
import com.projects.service.VerificationLoggingService;
                                        ...
                                        return Mono.zip(frontBytesMono, backBytesMono)
                                                        .flatMap(bytesTuple -> {
                                                                ...
                                                                return Mono.zip(frontOcr, backOcr)
                                                                                .flatMap(ocrTuple -> analysisService
                                                                                ...
                                                                                .flatMap(analysis -> {
                                                                                        ...
                                                                                        DocumentEntity doc = DocumentEntity
                                                                                                        ...
                                                                                                        .pieceType(finalType)
                                                                                                        .status("VERIFIED")
                                                                                                        .uploadDate(java.time.LocalDateTime
                                                                                                                        .now())
                                                                                                        .build();
                                                                                        ...
                                                                                        // properly in mono chain
                                                                                        Integer processTime = 1500; // Mocked
                                                                                                                    // for
                                                                                                                    // now,
                                                                                                                    // real
                                                                                                                    // calculation
