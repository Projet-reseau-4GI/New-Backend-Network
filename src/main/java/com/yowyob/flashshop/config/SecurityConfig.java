                ...
                return http
                                ...
                                .authorizeExchange(exchange -> exchange
                                                ...
                                                .pathMatchers(
                                                                ...
                                                                "/api/auth/resend-otp",
                                                                "/api/auth/login",
                                                                "/api/admin/auth/loginSuperAdmin",
                                                                "/api/admin/auth/registerSuperAdmin",
                                                                "/api/admin/auth/verify-registrationSuperAdmin",
                                                ...
                                                // Public: Dashboard (restrict per platform via platformId in JWT if
                                                // needed)
