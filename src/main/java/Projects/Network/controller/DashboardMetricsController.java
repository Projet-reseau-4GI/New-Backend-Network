...
public class DashboardMetricsController {
    ...
    @Operation(summary = "Indicateurs clés (KPIs)",
               description = "Retourne total vérifications, succès, échecs, temps moyen, tokens API actifs.")
    public Mono<DashboardStatsDto> getStats(
            @Parameter(description = "ID de plateforme (optionnel, admin seulement)")
            @RequestParam(required = false) Long platformId,
            @Parameter(description = "Période prédéfinie: 7d | 30d | 90d (ignoré si from/to fournis)")
    ...
    @Operation(summary = "Évolution des vérifications",
               description = "Données pour le graphique linéaire (par jour/semaine/mois).")
    ...
    @Operation(summary = "Trafic par heure",
               description = "Nombre de vérifications par heure de la journée (0–23) pour le graphique en barres.")
    ...
    @Operation(summary = "Répartition succès / échec",
               description = "Données pour le graphique circulaire (ACCEPTED / REJECTED).")
    ...
    @Operation(summary = "Distribution par type de document",
               description = "Totaux et taux de succès par type de document.")
    ...
    @Operation(summary = "10 dernières vérifications",
               description = "Liste des 10 vérifications les plus récentes avec tous leurs détails.")
    ...
    @Operation(summary = "Exporter en CSV",
               description = "Télécharge un fichier CSV des vérifications récentes (compatible Excel).")
    ...
    @Operation(summary = "Exporter en PDF",
               description = "Génère un rapport PDF professionnel multi-sections.")
