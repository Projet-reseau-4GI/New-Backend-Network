...
public class PlatformService {
     ...
     */
    public Flux<Projects.Network.dto.PlatformTokenStatsDto> getPlatformTokenStats(String search) {
        String searchFilter = "";
        ...
        return db.sql(sql)
                .map((row, md) -> Projects.Network.dto.PlatformTokenStatsDto.builder()
